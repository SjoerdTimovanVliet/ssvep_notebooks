...
def present(n_stimuli=2, n_rounds=6, inter_trial_time=0.5, trial_duration=10, eeg=None, save_fn=None, mode='2 stimuli'):
    ...
    if mode == '2 stimuli':
        ...
        markernames = [10, 1, 2, 3, 4, 5, 6, 7, 8, 9]
    ...
    if eeg:
        ...
        eeg.start(save_fn, duration=record_duration) # Start the EEG stream with the desired duration (in seconds. Notapplicable for OpenBCI
